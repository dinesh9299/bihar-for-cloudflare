...
const navigation = [
  { name: "Dashboard", href: "/block/dashboard", icon: LayoutDashboard },
  // { name: "Surveys", href: "/surveys", icon: FileText },
  // { name: "Projects", href: "/projects", icon: FileText },
  // { name: "Cameras", href: "/cameras", icon: Camera },
  { name: "Locations", href: "/block/locations", icon: MapPin },
  { name: "Certificate", href: "/block/certificate", icon: FileText },
  ...
  { name: "Material", href: "/block/dispatch", icon: TableProperties },
  { name: "Account", href: "/block/me", icon: Users },
...
export function Blocksidebar({ isOpen = false, onClose }: ModernSidebarProps) {
