...
const navigation = [
  ...
  {
    name: "Assembly-Coordinators",
    href: "/district/assembly-coordinators",
    icon: TableProperties,
  },
  { name: "Assemblies", href: "/district/assemblies", icon: ShoppingCart },
  { name: "dispatch", href: "/district/dispatch", icon: TableProperties },
